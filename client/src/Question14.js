...
export default function Question14() {
  ...
  useEffect(() => {
    ...
    var config = {
      method: "get",
      url: "https://api.fastforex.io/fetch-all?api_key=ebfa47f4c1-844e0441cd-r713e3",
      headers: {},
    };
    ...
    <div className="main">
      <div className="sticky-sub-div">
        <h2 className="percent">
          {Math.round(((100 / 29) * 13).toString())}% завершено
        </h2>
        ...
        <div className="left-align-text">
          ...
          <p className="question">
            <strong>
              <span style={{ color: "#db536a" }}>USD/KZT</span>
            </strong>{" "}
            - Какие значения курса доллара США по отношению к казахстанскому
            тенге, по Вашему мнению, являются наиболее вероятными в перспективе
            следующих периодов?
          </p>
