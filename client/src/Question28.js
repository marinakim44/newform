...
export default function Question28() {
  useEffect(() => {
    ...
    if (localStorage.getItem("q28-checked")) {
      setChecked(JSON.parse(localStorage.getItem("q28-checked")));
    }
  ...
  useEffect(() => {
    ...
    localStorage.setItem("q28-checked", JSON.stringify(checked));
  }, [input, checked]);
    ...
    <div className="main">
      <div className="sticky-sub-div">
        <h2 className="percent">
          {Math.round(((100 / 29) * 28).toString())}% завершено
        </h2>
